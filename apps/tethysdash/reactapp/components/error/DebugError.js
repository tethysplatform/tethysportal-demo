    ...
    <div className="d-flex flex-column h-100 bg-light">
        ...
        <Container>
          ...
          <div id="tip-wrapper" className="mb-4">
            <Alert variant="info" className="d-inline-block">
              ...
              <p>
                Use the <b>React Developer Tools</b> extension for your browser
                to debug this error:
              </p>
              <ul>
                <li>
      ...
      <footer className="mt-auto">
        <Alert variant="warning" className="mb-0 rounded-0 px-5">
          <b>Important!</b> You&apos;re seeing this error because you have{" "}
          <code>TETHYS_DEBUG = true</code> in your <code>.env</code> file.
          Change that to <code>false</code> to display the standard error
          message page.
        </Alert>
      </footer>
    </div>
